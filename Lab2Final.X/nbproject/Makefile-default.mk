...
${OBJECTDIR}/Lab2Final.o: Lab2Final.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Lab2Final.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Lab2Final.lst\" -e\"${OBJECTDIR}/Lab2Final.err\" $(ASM_OPTIONS)   -o\"${OBJECTDIR}/Lab2Final.o\" \"Lab2Final.asm\" 
...
${OBJECTDIR}/Lab2Final.o: Lab2Final.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Lab2Final.o.d 
	@${RM} ${OBJECTDIR}/Lab2Final.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Lab2Final.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Lab2Final.lst\" -e\"${OBJECTDIR}/Lab2Final.err\" $(ASM_OPTIONS)   -o\"${OBJECTDIR}/Lab2Final.o\" \"Lab2Final.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/Lab2Final.o"
	@${FIXDEPS} "${OBJECTDIR}/Lab2Final.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab2Final.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w -x -u_DEBUG -z__ICD2RAM=1 -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_SIMULATOR=1 $(MP_LINKER_DEBUG_OPTION) -odist/${CND_CONF}/${IMAGE_TYPE}/Lab2Final.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
else
dist/${CND_CONF}/${IMAGE_TYPE}/Lab2Final.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
